...
namespace GPN
{
    ...
    protected:
        ...
        {
            return Hydrodynamic::ICFactory(
                well.history->start_time,
                well.grid2D_rocks,
                well.rock_field_props.base_hydrodynamics.ext_pressure);
        }
    ...
    public:
        ...
        static auto create_solver_ptr(
            const Wells::BotHoleRateControl::WellBottomHoleRateControl<History_t, Fluid_t, Grid2D_t, CrossFlow_t> &well,
            const FluidField_t &fluid_field)
        {
            using Well_t = Wells::BotHoleRateControl::WellBottomHoleRateControl<History_t, Fluid_t, Grid2D_t, CrossFlow_t>;
            ...
            const Properties::MediumCompressibility corrected_compressibility{make_corrected_compressibility(well)};
        ...
        template <
            ...
            typename FluidField_t>
        static auto create_solver_ptr(
            const Wells::ResFlowProfileControl::WellReservoirFlowProfileControl<History_t, Fluid_t, Grid2D_t, CrossFlow_t> &well,
            const FluidField_t &fluid_field)
        {
            using Well_t = Wells::ResFlowProfileControl::WellReservoirFlowProfileControl<History_t, Fluid_t, Grid2D_t, CrossFlow_t>;
